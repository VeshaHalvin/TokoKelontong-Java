...
import Controller.TPembelianController;
import Model.BBeli;
import Controller.BBeliController;
import Model.Produk;
 ...
 * @author LENOVO
 */
public class TPembelianPanel extends javax.swing.JPanel {
    private ProdukController PrC = new ProdukController();
    private TPembelianController dataControl = new TPembelianController();
    private BBeliController BLC = new BBeliController();
    private SupplierController SpC = new SupplierController();
    private List<Produk> DataProduk = new ArrayList<>();
    private TPembelian dataModel = null;
    private List<BBeli> DataBeli = new ArrayList<>();
    ...
    public TPembelianPanel() {
        ...
        idPembelianTextArea.setEnabled(false);
    }
    ...
    public void setSupplierToDropdown(){
        singleList = SpC.showListSupplier();
...
//        kodeProdukInput.setEnabled(value);
    ...
    public void showTableBySearch(String target){
        TransaksiTable.setModel(dataControl.showTableTPembelian(target));
    }
    ...
    private void initComponents() {
        ...
        KELOMPOK_KITA_ADA_YG_GALAU = new javax.swing.JPanel();
        idPembelianPanel = new javax.swing.JLabel();
        idPembelianTextArea = new javax.swing.JTextField();
        ...
        namaData2Panel1 = new javax.swing.JLabel();
        ...
        searchInputLabel8.setText("Pencarian Transaksi");
        ...
        KELOMPOK_KITA_ADA_YG_GALAU.setBackground(new java.awt.Color(255, 255, 255));

        idPembelianPanel.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 12)); // NOI18N
        idPembelianPanel.setText("ID Pembelian");

        idPembelianTextArea.setFont(new java.awt.Font("Berlin Sans FB", 0, 12)); // NOI18N
        idPembelianTextArea.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                idPembelianTextAreaActionPerformed(evt);
            }
        });

        javax.swing.GroupLayout KELOMPOK_KITA_ADA_YG_GALAULayout = new javax.swing.GroupLayout(KELOMPOK_KITA_ADA_YG_GALAU);
        KELOMPOK_KITA_ADA_YG_GALAU.setLayout(KELOMPOK_KITA_ADA_YG_GALAULayout);
        KELOMPOK_KITA_ADA_YG_GALAULayout.setHorizontalGroup(
            KELOMPOK_KITA_ADA_YG_GALAULayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(KELOMPOK_KITA_ADA_YG_GALAULayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(KELOMPOK_KITA_ADA_YG_GALAULayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(idPembelianPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(idPembelianTextArea))
                .addContainerGap())
        );
        KELOMPOK_KITA_ADA_YG_GALAULayout.setVerticalGroup(
            KELOMPOK_KITA_ADA_YG_GALAULayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(KELOMPOK_KITA_ADA_YG_GALAULayout.createSequentialGroup()
                .addGap(12, 12, 12)
                .addComponent(idPembelianPanel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(idPembelianTextArea, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        namaData2Panel.setText("Supplier");
        ...
        supplierPanelLayout.setHorizontalGroup(
            ...
            .addGroup(supplierPanelLayout.createSequentialGroup()
                ...
                .addGroup(supplierPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(supplierDropdown, 0, 284, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        namaData2Panel2.setText("Nama Produk");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(produkDropdown, 0, 284, Short.MAX_VALUE)
                    .addComponent(namaData2Panel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(produkDropdown, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        namaData2Panel1.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 12)); // NOI18N
        namaData2Panel1.setText("Tanggal Transaksi");
        ...
        tanggalPanelLayout.setHorizontalGroup(
            ...
            .addGroup(tanggalPanelLayout.createSequentialGroup()
                ...
                .addGroup(tanggalPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(namaData2Panel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(tanggalPanelLayout.createSequentialGroup()
        ...
        dataFormPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(dataFormPanel8Layout.createSequentialGroup()
                ...
                .addGroup(dataFormPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dataFormPanel8Layout.createSequentialGroup()
                        .addGroup(dataFormPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(KELOMPOK_KITA_ADA_YG_GALAU, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(dataFormPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dataFormPanel8Layout.createSequentialGroup()
                        .addComponent(detailProdukPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
                        .addGap(172, 172, 172))
                    .addGroup(dataFormPanel8Layout.createSequentialGroup()
            ...
            .addGroup(dataFormPanel8Layout.createSequentialGroup()
                ...
                .addGroup(dataFormPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dataFormPanel8Layout.createSequentialGroup()
                        .addGroup(dataFormPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(dataFormPanel8Layout.createSequentialGroup()
                                .addComponent(KELOMPOK_KITA_ADA_YG_GALAU, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void hapusTransaksiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusTransaksiButtonActionPerformed
        ...
        dataControl.deleteTPembelian(idTransaksi);
    ...
    private void tambahTransaksiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahTransaksiButtonActionPerformed
        ...
        idPembelianTextArea.setText(idTransaksi);
        setComponent(true);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try{
            ...
            Supplier selectedSingle = singleList.get(selectedIndexSingle);
            ...
            if(actionTransaksi.equals("tambah")){
                ...
                TPembelian dataNew = new TPembelian(idTransaksi, selectedSingle, tanggalInput.getText(), enTotalHarga);
                dataControl.insertTPembelian(dataNew);
                
                for (int i = 0; i < DataProduk.size(); i++) {
                    BBeli newB = new BBeli(idTransaksi, DataProduk.get(i), Jumlah.get(i));
                    BLC.insertBBeli(newB);
                }
            } else {
                TPembelian dataNew = new TPembelian(selectedSingle, tanggalInput.getText(), enTotalHarga);
                dataControl.updateTPembelian(dataNew, idTransaksi);
                idTransaksi = "";
            }
        ...
        Jumlah.clear();
        DataBeli.clear();
        List<BBeli> test= new ArrayList<>();
        detailTable.setModel(new detailBeliTable(test));
        counter = 0;
    ...
    private void TransaksiTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TransaksiTableMouseClicked
        ...
        for(Supplier first : singleList){
            if(first.getId().equals(SpC.searchSupplier(tableModel.getValueAt(clickedRow, 1).toString()).getId())){
                indexSingle = singleList.indexOf(first);
            }
        }
        
        List<BBeli> test = BLC.listBjual(tableModel.getValueAt(clickedRow, 0).toString());
        for (BBeli bJual : test) {
            DataProduk.add(bJual.getProduk());
            Jumlah.add(bJual.getJumlah());
            counter+=1;
        }
        detailTable.setModel(BLC.showTableBBeli(tableModel.getValueAt(clickedRow, 0).toString()));
    ...
    private void idPembelianTextAreaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_idPembelianTextAreaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_idPembelianTextAreaActionPerformed
    ...
    private javax.swing.JPanel KELOMPOK_KITA_ADA_YG_GALAU;
    ...
    private javax.swing.JLabel idPembelianPanel;
    private javax.swing.JTextField idPembelianTextArea;
    ...
    private javax.swing.JLabel namaData2Panel1;
